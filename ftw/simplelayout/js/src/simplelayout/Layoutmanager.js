...
export default function Layoutmanager() {
  ...
  let template = `<div class='sl-simplelayout'></div>`
  ...
  this.getInsertedLayouts = function() {
    return $.grep(
      $.map(this.layouts, function(layout) {
        return layout
      }),
      function(layout) {
  ...
  this.restore = function(restoreElement, represents) {
    ...
    $('.sl-layout', restoreElement).each(function() {
      _this.insertLayout().restore(this, _this, $('.sl-column', this).length)
    })
  }
