...
export default function Block(content, type) {
  ...
  let frame = $(Handlebars.compile('<div class="iFrameFix"></div>')())

  let template = `<div data-type="{{type}}" class="sl-block {{type}}"><div class="sl-block-content">{{{content}}}</div></div>`
